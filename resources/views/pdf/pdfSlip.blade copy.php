            ...
            <div class="table-container">
                ...
                <div class="slip-grid to-date-row">
                    ...
                    <div style="width: 100%;text-align:right;margin-top:-50%;">
                        <strong>Date:</strong>
                        <span style="font-family: Arial, Helvetica, sans-serif;">{{ \Carbon\Carbon::parse($dateText)->format('F d, Y') }}</span>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td style="width:50%; vertical-align: top; text-align:left;">
                                @foreach (['Appropriate Action', 'Calendar', 'Comment & Recommendation', 'Draft Reply', 'Endorsement'] as $leftItem)
                                    <div class="remark-item">
                                        <img src="{{ $routingPdf->trans_remarks === $leftItem
                            ...
                            <td style="width:50%; vertical-align: top; text-align:left;">
                                @foreach (['File', 'Information', 'Review/Study', 'See the Office', 'Others'] as $rightItem)
                                    <div class="remark-item">
                                        <img src="{{ $routingPdf->trans_remarks === $rightItem
                                            ? public_path('template/img/square_check.png')
                                            : public_path('template/img/square.png') }}"
                                            alt="Checkmark" class="remark-img">
                                        <span>{{ $rightItem }}</span>
                ...
                <div class="row" style="width: 100%;">
                    <table style="text-align:center;width: 100%;">
                        <tr>
                            {{-- E-SIGNATURE --}}
                            @if ($signatoryEsig && isset($signatoryEsig->esig_path))
                                <div style="margin-bottom: 0;margin-bottom:-6%;">
                                    <img src="{{ $signatoryEsig->esig_path }}" alt="Electronic Signature"
                                        style="height:70px;">
                                </div>
                            @endif
