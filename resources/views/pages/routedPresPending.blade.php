                   ...
                   <div class="col-12">
                       <div class="card position-relative text-center">
                           ...
                           <div class="card-header">
                               ...
                               <h4>Routed To Recipient For Acknowledgement</h4>
                           </div>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                       @if ($doc->routing_status == 1)
                                                           <span class="badge badge-warning">Routed To President</span>
                                                       @elseif($doc->routing_status == 2)
                                                           <span class="badge badge-info">Routed Back To Records</span>
                                                       @elseif($doc->routing_status == 3)
                                                           <span class="badge bg-success">Routed To Recipient</span>
                                                       @else
                                                   ...
                                                   <td>
                                                       <div class="buttons">
                                                           ...
                                                           <a href="{{ route('editRecall', ['id' => $doc->id]) }}"
                                                               class="btn btn-icon btn-info edit-slip-btn" target="_blank"><i
                                                                   class="fas fa-undo"></i>
                                                           </a>
