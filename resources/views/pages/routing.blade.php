                   ...
                   <div class="col-12">
                       <div class="card position-relative text-center">
                           ...
                           <div class="card-header">
                               ...
                               <h4>Routed To Records Office</h4>
                           </div>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                       @if ($doc->routing_status == 1)
                                                           <small> <span class="badge badge-warning">Routed To
                                                                   President</span></small>
                                                       @elseif($doc->routing_status == 2)
                                                           <span class="badge badge-danger">Routed Back To <br>
                                                               Records</span>
                                                   ...
                                                   <td>
                                                       <div class="buttons">
                                                           ...
                                                           @if ($doc->routing_status == 3)
                                                               <button class="btn btn-icon btn-secondary edit-slip-btn"
                                                                   disabled>
                                                                   <i class="fas fa-plus"></i>
                                                               </button>
                                                           @elseif ($doc->routing_status == 2 && $doc->reassigned_to == 1)
                                                               <a href="{{ route('editRerouteEntry', ['id' => $doc->id]) }}"
                                                                   class="btn btn-icon btn-info edit-slip-btn"
                                                                   target="_blank">
                                                                   <i class="fas fa-edit"></i> Reroute
                                                               </a>
                                                           @else
                                                               <a href="{{ route('editRoutingEntry', ['id' => $doc->id]) }}"
                                                                   class="btn btn-icon btn-success edit-slip-btn">
                                                                   <i class="fas fa-plus"></i>
                                                               </a>
                                                           @endif
